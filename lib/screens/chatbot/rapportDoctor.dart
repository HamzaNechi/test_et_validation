...
class RapportDoctor extends StatefulWidget {
  final String id_patient;
  const RapportDoctor({super.key,required this.id_patient});
  @override
  State<RapportDoctor> createState() => _RapportDoctorState();
}

class _RapportDoctorState extends State<RapportDoctor> {
